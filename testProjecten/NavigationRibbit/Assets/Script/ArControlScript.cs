...
public class ArControlScript : MonoBehaviour
{
    ...
    public GameObject CreateArrow() /* find or create Arrow AR, return script of arrow */
    {
        ...
        {
            arrowObj = arrowList[0].gameObject; //not transform to gameobject
    ...
    public GameObject CreateCheckTrue()//create checkTrue with transform data and return the checktrueObject
    {
        ...
        if (checktrueList.Count == 1)//if check returns 1 use the object again, if 0 or more destroy all and create new one
        {
    ...
    public GameObject CreateDescriptionBoard() //create descriptionBoard with roomname and roomDestination, returns the desBoardObject
    {
        ...
        if (desBoardList.Count == 1)//if check returns 1 use the object again, if 0 or more destroy all and create new one
        {
            desBoardObj = desBoardList[0].gameObject; //not transform to gameobject
